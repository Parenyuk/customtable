...
export const CustomInput = ({headerName, type, options}) => {
    ...
    if (type === 'selector' && headerName == 'Status') return <CustomSelect type={type}
                                                                            renderOptions={uniqueStatusOptions}
                                                                            onChange={changeFilterValue}
                                                                            value={filterValue}
                                                                            headerName={headerName}
    />
    else if (type === 'selector' && headerName == 'Type') return <CustomSelect type={type}
                                                                               renderOptions={uniqueTypeOptions}
                                                                               onChange={changeFilterValue}
                                                                               value={filterValue}
                                                                               headerName={headerName}
    />
    ...
    return (
        <div>
            <input placeholder={headerName} type={type} onChange={changeFilterValue} className={classes.input}
                   value={filterValue} onKeyPress={onFilterByEnterButton}/>
        </div>
    )
